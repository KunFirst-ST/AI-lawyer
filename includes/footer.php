...
$profileImageVersion = (string) (@filemtime(dirname(__DIR__) . '/assets/js/profile-image-ui.js') ?: time());
...
<script src="<?= e(url('/assets/js/profile-image-ui.js') . '?v=' . $profileImageVersion) ?>"></script>
