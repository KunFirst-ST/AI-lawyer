...
<div class="list-group app-sidebar">
    ...
    <a class="list-group-item list-group-item-action<?= e($isActive('/lawyer/messages.php')) ?>" href="<?= e(url('/lawyer/messages.php')) ?>"><i class="bi bi-chat-square-dots me-2"></i>แชตลูกความ<?php if ($chatUnread): ?><span class="badge text-bg-primary float-end"><?= e((string) min($chatUnread, 99)) ?></span><?php endif; ?></a>
