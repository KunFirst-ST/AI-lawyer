...
<div class="app-card p-3 table-responsive"><table class="table"><thead><tr><th>เคส</th><th>ผู้ใช้</th><th>หมวด</th><th>Match</th><th>Status</th></tr></thead><tbody>
<?php foreach ($cases as $case): ?><tr><td><?= e($case['title']) ?></td><td><?= e($case['user_name']) ?></td><td><?= e($case['category_name'] ?? '-') ?></td><td><?= e($case['match_status']) ?></td><td><?= e($case['status']) ?></td></tr><?php endforeach; ?>
