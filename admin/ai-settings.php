...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    flash('success', 'บันทึกการตั้งค่า AI แล้ว');
...
<section class="dashboard-shell">
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-lg-9">
                <h1 class="h3 fw-bold mb-3">ตั้งค่า AI และข้อมูลรับชำระ</h1>
                <div class="app-card p-4 mb-3">
                    <h2 class="h5 fw-bold">แนวทางคำตอบของ AI</h2>
                    <textarea class="form-control" rows="14" readonly><?= e($aiConfig['system_prompt']) ?></textarea>
                    <div class="small-muted mt-2">ตั้งค่า API key ผ่านตัวแปร OPENAI_API_KEY ในไฟล์ .env หรือ config ที่ระบบใช้งาน</div>
                </div>
                <div class="app-card p-4">
                    <form method="post" class="row g-3">
                        ...
                        <div class="col-md-4"><label class="form-label">ค่าบริการระบบ (%)</label><input class="form-control" type="number" step="0.01" name="commission_percent" value="<?= e(setting('commission_percent', '20')) ?>"></div>
                        <div class="col-md-8 d-flex align-items-end"><div class="form-check"><input class="form-check-input" type="checkbox" name="auto_match_after_consent" id="autoMatch" <?= setting('auto_match_after_consent', '1') === '1' ? 'checked' : '' ?>><label class="form-check-label" for="autoMatch">จับคู่ทนายอัตโนมัติหลังผู้ใช้ยินยอม</label></div></div>
