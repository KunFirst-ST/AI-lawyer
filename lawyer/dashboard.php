                ...
                <?php else: ?>
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div>
                            ...
                            <p class="text-muted mb-0">สถานะโปรไฟล์: <span class="badge text-bg-light text-dark"><?= e($lawyer['status']) ?></span> <?= (int) $lawyer['verified'] ? '<span class="badge text-bg-success">Verified</span>' : '' ?></p>
                        </div>
                        <form method="post">
